...
public class DemoCommit {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        trans_ref = System.currentTimeMillis()+"";
    ...
    private void sendPost(String access_key, String command, String trans_ref)
        ...
        String secretKey = "ta96fcp6zw46jt1rtgqed52rrh73yij8"; // product's secret key (get value from TrueMoney Pay product detail)
        String signature = generateSignature(access_key, command, trans_ref, secretKey);
